...
export default class ElementHead {
    ...
    static SPECIAL_LIQUID_ACID = 2;
    static SPECIAL_LIQUID_OIL = 4;
    static SPECIAL_LIQUID_WATER_STAINED = 6;
    static SPECIAL_LIQUID_WATER = 8;
    static SPECIAL_LIQUID_MOLTEN_METAL = 12;
